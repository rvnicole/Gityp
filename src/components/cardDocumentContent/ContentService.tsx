        ...
        <div>
            {
                numFechasDuplicados > 1 ? 
                    <p className="text-right"><span className={`${coloresDuplicados[numFechasDuplicados]} bg- text-white font-semibold px-2 py-1 rounded-2xl`}>{formatLongDate(new Date(evalDate(document.fechaEjecucion)))}</span></p>
                :
                    <p className="text-right">{formatLongDate(new Date(evalDate(document.fechaEjecucion)))}</p>
            }                                     
